    ...
    if (state.vrm && state.vrm.humanoid) {
      ...
      if (moving) {
        ...
        if (bone('leftUpperArm')) {
          bone('leftUpperArm').rotation.z =  1.25;
          bone('leftUpperArm').rotation.x =  swing * 0.85;
        }
        // 【右上臂】放下（z=-1.2）並反向擺動
        if (bone('rightUpperArm')) {
          bone('rightUpperArm').rotation.z = -1.25;
        ...
        if (bone('leftUpperArm')) {
          ...
          bone('leftUpperArm').rotation.z =  1.25 + breathe * 0.4;
          bone('leftUpperArm').rotation.x =  0;
        }
        if (bone('rightUpperArm')) {
          bone('rightUpperArm').rotation.z = -1.25 - breathe * 0.4;
